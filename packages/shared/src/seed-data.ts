...
export const SEED_MENUS: Menu[] = [
  ...
  { id: 515, parentId: 200, title: '监控告警',   name: 'SystemMonitorAlerts', path: '/system/monitor-alerts',     component: 'system/monitor-alerts/MonitorAlertsPage',        icon: 'Siren',             type: 'menu',      sort: 7,  status: 'enabled', visible: true,  permission: 'system:monitor:alert',         createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 519, parentId: 200, title: '告警记录',   name: 'SystemMonitorAlertEvents', path: '/system/monitor-alert-events', component: 'system/monitor-alert-events/MonitorAlertEventsPage', icon: 'History',     type: 'menu',      sort: 8,  status: 'enabled', visible: true,  permission: 'system:monitor:alert',         createdAt: SEED_DATE, updatedAt: SEED_DATE },

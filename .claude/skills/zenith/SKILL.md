...
| 9. 菜单/权限 | `packages/shared/src/seed-data.ts` | [menu-seed.md](./references/menu-seed.md) |
| 10. 种子数据 | `packages/server/src/db/seed.ts` | [menu-seed.md](./references/menu-seed.md) |
